...
export default function Solicitudes() {
    ...
    const redirectEncuestaDocente=()=>{
        router.push('/alumno/encuestas/encuestaDocente');
    }

    const redirectEncuestaJP=()=>{
      router.push('/alumno/encuestas/encuestaJP');
  }
        ...
        <CardMenu>
           ...
           <Button color='white 'fullWidth sx={{ marginLeft: 3,border: 1, borderColor: 'black',
            ...
            '&:hover': {
             ...
             Encuesta Docente {/*Aqui va el texto para todos los botones del menu*/}
           </Button>
           ...
           <Button color='white 'fullWidth sx={{ marginLeft: 3,border: 1, borderColor: 'black',
            ...
            '&:hover': {
             ...
             Encuesta JP {/*Aqui va el texto para todos los botones del menu*/}
           </Button>
