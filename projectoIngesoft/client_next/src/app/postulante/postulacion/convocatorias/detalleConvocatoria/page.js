    ...
    <Box sx={{ backgroundColor: 'white', minHeight: '100vh', paddingBottom: '10px' }}>
      ...
      >
        ...
        >
          ...
          <Box sx={{ marginLeft:'30px',padding: 4 }}>
            ...
            <Box sx={{justifyContent:'center',alignItems:'center',display:'flex',marginTop:'20px'}}>
              <Button variant="outlined" onClick={retornarAListado}>Regresar</Button>
            </Box>
