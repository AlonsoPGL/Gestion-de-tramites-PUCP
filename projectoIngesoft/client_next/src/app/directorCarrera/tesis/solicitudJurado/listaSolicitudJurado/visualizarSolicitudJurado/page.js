"use client";
import { Table,Button, Typography, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Checkbox, Box, TextField } from '@mui/material';
  ...
  const router=useRouter();
    ...
    return (
        <Box sx={{ backgroundColor: 'white', color: 'white', height: '100vh',marginBottom:'20px' }}>
            ...
            >
                <Box>
                <Typography variant="h4" sx={{ marginLeft:'20px', fontWeight: 'bold', color: 'black' }}>SOLICITUD DE JURADO</Typography>
                </Box>
                <Box sx={{display:'flex'}}>
