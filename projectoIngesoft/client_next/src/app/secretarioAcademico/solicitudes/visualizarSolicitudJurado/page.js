...
import TablaDePeticionesJurado from 'componentesSecretarioAcadémico/solicitudJurado/TablaPeticionJurado';
export default function ListadoSolicitudJurado() {
    ...
    return (
        <Box sx={{ backgroundColor: 'white', color: 'white', height: '100vh' }}>
            ...
            >
                <Box>
                <Typography variant="h4" sx={{ marginLeft:'20px', fontWeight: 'bold', color: 'black' }}>SOLICITUD DE ASIGNACIÓN DE JURADO</Typography>
                </Box>
                ...
                <Box sx={{padding:'20px',display: 'flex', justifyContent: 'space-between', width: '100%'}}>
                    ...
                    <Button 
                        component={Link}
                        href="visualizarSolicitudJurado/registrarSolicitud"
                        variant="contained" 
                        color="primary" startIcon={<AddCircleOutlineIcon />}
                ...
                <Box sx={{marginLeft:'20px',marginRight:'20px'}}>
                    <TablaDePeticionesJurado solicitudesTemaTesis={solicitudesFiltradas}></TablaDePeticionesJurado>
