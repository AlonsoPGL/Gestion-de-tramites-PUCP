...
export default function EncuestaDocente() {
    ...
    return (
        ...
        <CardMenu>
            ...
            '&:hover': {
             ...
             }}/>} onClick={redirectGestionEncuestaDocente}> {/*ManejarClic es la funcion que debes pasar al boton para que sea eso lo que realiza con un clic*/}
             GESTIÓN DE ENCUESTA DOCENTE {/*Aqui va el texto para todos los botones del menu*/}
           </Button>
