...
export default function RegistrarEncuesta() {
  ...
  const handleGuardarEncuesta = async () => {
    ...
    try {
      ...
      const endpoint = isEditingEncuesta ? `http://localhost:8080/preguntas/encuesta/actualizar/${encuesta.id_Encuesta}` : 'http://localhost:8080/preguntas/encuesta/insertarJP';
