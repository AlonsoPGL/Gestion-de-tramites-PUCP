...
export default function RegistrarEncuesta() {
  ...
  const [fechaInicio, setFechaInicio] = useState(dayjs());  // O usa null si prefieres
  ...
  const handleGuardarEncuesta = async () => {
    ...
    try {
      ...
      const endpoint = isEditingEncuesta ? `http://localhost:8080/preguntas/encuesta/actualizar/${encuesta.idEncuesta}` : 'http://localhost:8080/preguntas/encuesta/insertar';
