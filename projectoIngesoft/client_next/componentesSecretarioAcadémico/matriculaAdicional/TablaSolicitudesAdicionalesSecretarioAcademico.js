...
const TablaSolicitudesAdicionalesSecretarioAcademico = ({ solicitudes = [] }) => {
  ...
  const handleModificarClick = (solicitud) => {
    ...
    router.push(`/secretarioAcademico/solicitudes/matriculaAdicional/visualizarSolicitud?id=${solicitud.id}`);
  };
...
export default TablaSolicitudesAdicionalesSecretarioAcademico;
