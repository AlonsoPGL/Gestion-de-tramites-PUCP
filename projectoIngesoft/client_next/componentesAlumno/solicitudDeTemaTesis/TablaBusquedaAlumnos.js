...
const TablaBusquedaAlumnos = ({ onClose, alumnosBase, setAlumnos }) => {
  ...
  async function fetchAlumnosPorParametros({ nombre, apellidoPaterno, apellidoMaterno, codigo }) {
    try {
      // Filtrar solo los parámetros que no están vacíos
      const params = { apellidoPaterno, apellidoMaterno, nombre, codigo };
...
export default TablaBusquedaAlumnos;