...
import TablaBusquedaAlumnos from "componentesAlumno/solicitudDeTemaTesis/TablaBusquedaAlumnos";
...
const BusquedaAlumno = ({ open, onClose, alumnos,setAlumnos}) => {
    return (
    <Modal
        open={open}
        onClose={onClose}
        ...
        <Box sx={style}>
            <Box>
                <TablaBusquedaAlumnos onClose={onClose} alumnosBase={alumnos} setAlumnos={setAlumnos}></TablaBusquedaAlumnos>
            </Box>
